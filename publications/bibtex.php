	...
	var $resultedHtml;
        ...
        function htmlPublication($type, $fields, $element) {
                         ...
                         switch ($print) {
                            case "title":
                                ...
                                if(isset($this->sortedItems['url'][$element])){
                                    $this->resultedHtml .= '<a href="'.$this->sortedItems['url'][$element].'" class="publications-title" color="#2E6CA3" target="_blank">';
                                }
                            ...
                            case "author":
                                if($this->sortedItems[$print][$element]!="")
								{
									$authStr=str_replace("Carver, Jeffrey C.","<b>Carver, Jeffrey C.</b>",$this->sortedItems[$print][$element]);
                                    $this->resultedHtml .= $authStr.", ";
                            ...
                            case "award":
                                if($this->sortedItems[$print][$element]!="")
                                    $this->resultedHtml .= " <font color='blue'><b>" . $this->sortedItems[$print][$element]."</b></font> ";
            ...
            //    $this->resultedHtml .= '&nbsp;<a href="#bibtex-'.$element.'" title="Bibtex Citation" id="publink-'.$element.'"><i class="fa fa-bold"></i></a>';
                $this->resultedHtml .= '&nbsp;<a href="#bibtex-'.$element.'" title="Bibtex Citation" id="publink-'.$element.'"><img src="images/BibTeX_logo.png" height="17" alt="BibTeX icon" style="">&nbsp&nbsp</a>';
            ...
            if (isset($this->sortedItems['durl'][$element])) {
                $this->resultedHtml .= '<a target="_blank" title="PDF" class="publications-title" href="'.$this->sortedItems['durl'][$element].'"><img src="images/pdf.gif" height="17" alt="large ppt icon" style=""></a>';
            }
            if (isset($this->sortedItems['powerpoint'][$element])) {
                $this->resultedHtml .= '<a target="_blank" title="Powerpoint" class="publications-title" href="'.$this->sortedItems['powerpoint'][$element].'"><img src="images/ppt.gif" height="17" alt=”large power point icon” style=""></a>';
            }
