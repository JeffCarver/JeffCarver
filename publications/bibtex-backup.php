	...
	var $resultedHtml;
                         ...
                         switch ($print) {
                            case "title":
                                ...
                                if(isset($this->sortedItems['url'][$element])){
                                    $this->resultedHtml .= '<a href="'.$this->sortedItems['url'][$element].'" class="publications-title" target="_blank">';
                                }
		...
		$this->resultedHtml .= '<div style="display:none"><div id="bibtex-'.$element.'"><pre>'.$this->sortedItems['raw'][$element].'</pre></div></div>';
            ...
            if (isset($this->sortedItems['durl'][$element])) {
                $this->resultedHtml .= '<a target="_blank" title="PDF" class="publications-title" href="'.$this->sortedItems['durl'][$element].'"><img src="images/pdf.gif" height="17">&nbsp;</a>';
            }
            if (isset($this->sortedItems['powerpoint'][$element])) {
                $this->resultedHtml .= '<a target="_blank" title="Powerpoint" class="publications-title" href="'.$this->sortedItems['powerpoint'][$element].'"><img src="images/ppt.gif" height="17">&nbsp;</a>';
            }
		...
		function printPublications() {
            ...
            for($i = 0; $i < count($this->typeData); $i++) {
               if (isset($this->typeData[$i]) && $this->typeData[$i] == "book-chap")
